...
const projects = [
  {
    title: "Simulador para el entrenamiento en el pilotaje de un cuadricoptero en entornos virtuales",
    description:
      "A ....",
    image: "/projects/project1.jpeg",
    tags: ["ROS ", "Ubuntu", "Python"],
    link: "#",
    github: "#",
  },
  {
    title: "Sistema de reservas de launges en Coco Bongo",
    description:
      "A ....",
  ...
  {
    title: "PIN Escaner Entel de tarjetas Prepago",
    description:
      "An .....",
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mx-auto max-w-3xl mb-16">
          ...
          <p className="text-muted-foreground animate-fade-in animation-delay-200">
            Una selección de mis trabajos recientes, desde aplicaciones web complejas 
            hasta herramientas innovadoras que resuelven problemas reales.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, idx) => (
            <div
              key={idx}
              className="group glass rounded-2xl overflow-hidden animate-fade-in hover:shadow-xl transition-all duration-500"
